document.getElementById("body").style.background = "hsl(218, 28%, 13%)";
document.getElementById("text").innerHTML = "All your files in one secure location, accessible anywhere.";
